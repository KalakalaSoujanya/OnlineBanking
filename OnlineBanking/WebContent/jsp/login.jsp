...
<td><form:radiobutton path="userType" label="Admin" value="admin"/>&nbsp;&nbsp;<form:radiobutton path="userType" label="Employee" value="Employee"/>&nbsp;&nbsp;<form:radiobutton path="userType" label="Customer" value="customer"/></td>
