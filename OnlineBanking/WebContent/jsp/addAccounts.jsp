...
<br><br><br><br><br>
<form:form method="post" action="addAccounts?id=${param.id }" modelAttribute="account">
<table width="30%" align="center" border="0">
<tr bgcolor="grey"><td colspan="2"><b>Add Employees</b></td></tr>
<tr><td colspan="3">&nbsp;</td></tr>
<tr><td><b><form:label path="accountNumber">Account Number</form:label></b></td>
<td><form:input path="accountNumber" /></td>
<td><form:errors path="accountNumber" /></td></tr>
<tr><td><b><form:label path="accountType">AccountType</form:label></b></td>
<td><form:input path="accountType" /></td>
<td><form:errors path="accountType" /></td></tr>
<tr><td><b><form:label path="customerId">CustomerId</form:label></b></td>
<td><form:input path="customerId"  value="${param.id}" /></td>
<td><form:errors path="customerId" /></td></tr>
<tr><td><b><form:label path="balance">Balance</form:label></b></td>
<td><form:input path="balance" /></td>
<td><form:errors path="balance" /></td></tr>
<tr><td colspan="3">&nbsp;</td></tr>
